...
public class PhysicsGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_physics_game);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent =new Intent(PhysicsGame.this,MenuScreen.class);
        ...
        timer = new CountDownTimer(maxProg*1000,1000) {
            ...
            public void onTick(long l) {
                if(secondsRemaining<0)
                {
                    ...
                    {
                        Database_class databaseHelper = new Database_class(PhysicsGame.this);
                        if (g.getScore() > gameApi.getHighScore()) {
                ...
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    collectionReference.document(documentId).update(details).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void unused) {
                            Toast.makeText(PhysicsGame.this,"Updating HighScore",Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PhysicsGame.this,"Updating HighScore Failed",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
                {
                    Toast.makeText(PhysicsGame.this,"Cannot Find Document",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful() && !task.getResult().isEmpty()){
                    ...
                    collectionReference.document(documentId).update(details).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void unused) {
                            Toast.makeText(PhysicsGame.this,"Updating GemCount",Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PhysicsGame.this,"Updating GemCount Failed",Toast.LENGTH_SHORT).show();
                        }
                    });
                }
                else
